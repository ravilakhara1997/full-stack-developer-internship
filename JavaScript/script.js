...
// accessing the second paragraph and adding text to the paragraph
document.getElementById("p2").innerHTML = "JavaScript is a powerful, flexible, and fast programming language.";
// accessing the third paragraph and adding text to the paragraph
document.getElementById("p3").innerHTML = "JavaScript powers the dynamic behavior on websites.";
